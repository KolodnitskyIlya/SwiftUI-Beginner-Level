...
struct ModelMyFirstProject: View {
    
    @State var users: [UserModel] = [
        //"Ilya", "Semen", "Sasha", "Chris"
        UserModel(displayName: "Ilya", userName: "ilya123", followerCount: 100, isVerified: true),
